...
export EXPAT_SRC_ROOT=${HOME}/src/expat-2.2.0
export BINUTILS_SRC_ROOT=${HOME}/src/binutils-2.27
export GDB_SRC_ROOT=${HOME}/src/gdb-7.12
export MAKE_SRC_ROOT=${HOME}/src/make-4.2.1

export NR_JOBS=`cat /proc/cpuinfo | grep '^processor\s*:' | wc -l`
export BUILD_TRIPLET=`/usr/share/misc/config.guess`
export TARGET_TRIPLET=i686-w64-mingw32
export LOGGER_TAG=native-win32-gcc-5
export SYS_ROOT=${HOME}/native/gcc-5-win32
export SYS_3RD_ROOT=${HOME}/native/gcc-5-win32-3rd
export OBJ_ROOT=${HOME}/obj/native/gcc-5-win32
export PATH=${HOME}/cross/i686-windows-gcc-5/bin:${HOME}/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
