...
export LOGGER_TAG=native-win32-gcc-6
export SYS_ROOT=${HOME}/native/gcc-6-win32
export SYS_3RD_ROOT=${HOME}/native/gcc-6-win32-3rd
export OBJ_ROOT=${HOME}/obj/native/gcc-6-win32
export PATH=${HOME}/cross/i686-windows-gcc-6/bin:${HOME}/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
