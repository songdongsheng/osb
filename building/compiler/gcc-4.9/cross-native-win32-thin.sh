...
export LOGGER_TAG=native-win32-gcc49
...
export PATH=${HOME}/cross/i686-windows-gcc49/bin:/usr/sbin:/usr/bin:/sbin:/bin
...
${GCC_SRC_ROOT}/configure \
    ...
    --with-arch=corei7 --with-tune=generic
...
source $BASE_DIR/version.sh "${SYS_ROOT}"
