...
export MINGW_W64_SRC_ROOT=${HOME}/vcs/git/mingw-w64-v2.x
export BINUTILS_SRC_ROOT=${HOME}/src/binutils-2.24

export NR_JOBS=`cat /proc/cpuinfo | grep '^processor\s*:' | wc -l`
export BUILD_TRIPLET=`/usr/share/misc/config.guess`
export TARGET_TRIPLET=x86_64-w64-mingw32
export LOGGER_TAG=cross-win64-gcc-4.7
export SYS_ROOT=${HOME}/cross/x86_64-windows-gcc-4.7
export OBJ_ROOT=${HOME}/obj/${TARGET_TRIPLET}-gcc-4.7
...
${GCC_SRC_ROOT}/configure \
    ...
    --enable-fully-dynamic-string --with-arch-64=core2 --with-arch-32=core2 --with-tune=generic
